# ERP Knowledge Assistant 200Q Test Report
...
- `schema`: total `50`, PASS `47`, PARTIAL `3`, MISS `0`
- `additional_functions`: total `40`, PASS `36`, PARTIAL `4`, MISS `0`
...
- Evidence:
  ...
  - `ComarchOptimaReference` -> `docs/reference/ComarchKB_CrossKB_Practical_Test.md`
