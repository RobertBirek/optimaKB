...
Generated: `2026-07-31T04:03:00.272Z`
...
- Semi-auto active: `true`
  ...
  - ComarchOptimaReference: threshold=0.95 (active)
  - ComarchOptimaPartnerTechnical: threshold=0.95 (not eligible)
  - ComarchBetterflyReference: threshold=0.95 (active)
  - ComarchCommunityNews: threshold=0.5 (not eligible)
  - TaxbellLegalReference: threshold=0.95 (active)
  - TaxbellPayrollHRReference: threshold=0.95 (active)
  - TaxbellAccountingVATReference: threshold=0.95 (active)
...
- `seed_ComarchOptimaReference`: DUPLICATE_HEAVY, efficiency 60
