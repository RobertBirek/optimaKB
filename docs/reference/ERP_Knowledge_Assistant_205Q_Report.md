# ERP Knowledge Assistant 205Q Test Report
...
- `additional_functions`: total `41`, PASS `41`, PARTIAL `0`, MISS `0`
- `sprint`: total `30`, PASS `30`, PARTIAL `0`, MISS `0`
- `reference`: total `20`, PASS `20`, PARTIAL `0`, MISS `0`
- `partner`: total `31`, PASS `31`, PARTIAL `0`, MISS `0`
- `betterfly`: total `30`, PASS `30`, PARTIAL `0`, MISS `0`
- `taxbell_accounting_vat`: total `1`, PASS `1`, PARTIAL `0`, MISS `0`
- `taxbell_legal`: total `1`, PASS `1`, PARTIAL `0`, MISS `0`
- `taxbell_payroll_hr`: total `1`, PASS `1`, PARTIAL `0`, MISS `0`
...
- Actual primary KB: `ComarchOptimaAdditionalFunctions`
- Support KBs: `ComarchOptimaPartnerTechnical`, `ComarchOptimaSchema`
- Question: Które słowniki partnerów są wykorzystywane do definiowania funkcji dodatkowych?
- Evidence:
  - `ComarchOptimaAdditionalFunctions` -> `exports/optima_additional_functions/v1/implementation_example.csv`
  - `ComarchOptimaAdditionalFunctions` -> `docs/reference/ComarchOptimaAdditionalFunctions.seed.md`
  - `ComarchOptimaAdditionalFunctions` -> `exports/optima_additional_functions/v1/implementation_guide.csv`
...
- Actual primary KB: `ComarchOptimaAdditionalFunctions`
- Support KBs: `ComarchOptimaPartnerTechnical`, `ComarchOptimaSchema`
- Question: Które partnerowe słowniki są wykorzystywane w definiowaniu funkcji dodatkowych?
- Evidence:
  - `ComarchOptimaAdditionalFunctions` -> `exports/optima_additional_functions/v1/implementation_example.csv`
  - `ComarchOptimaAdditionalFunctions` -> `docs/reference/ComarchOptimaAdditionalFunctions.seed.md`
  - `ComarchOptimaAdditionalFunctions` -> `exports/optima_additional_functions/v1/implementation_guide.csv`
...
- Question: Jak prawidłowo wystawić fakturę w KSeF zgodnie z przepisami VAT i ująć ją w deklaracji?
- Evidence:
...
- Question: Jakie są najważniejsze interpretacje podatkowe dotyczące nowelizacji ustawy o PIT w 2025 roku?
- Evidence:
...
- Support KBs: `TaxbellLegalReference`
- Question: Jakie są obowiązki pracodawcy dotyczące naliczania składek ZUS od wynagrodzenia pracownika w 2025 roku?
- Evidence:
