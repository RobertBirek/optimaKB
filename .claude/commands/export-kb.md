...
Profile requested: $ARGUMENTS

Map the profile to the correct export script:
...
Output goes to `exports/<kb>/v1/`. Confirm by listing the output directory after completion. If no profile was given in $ARGUMENTS, ask which one to use.
