...
const PROJECT_NAME = process.env.OPENSPG_PROJECT_NAME || 'Comarch Community News';
const NAMESPACE = process.env.OPENSPG_NAMESPACE || 'ComarchCommunityNews';
const DESCRIPTION =
  process.env.OPENSPG_PROJECT_DESCRIPTION ||
  'Public read-only Comarch community news corpus used as a supporting awareness and routing KB.';
...
const SCHEMA_FILE =
  ...
  path.join(ROOT, 'docs/reference/ComarchCommunityNews.schema');
